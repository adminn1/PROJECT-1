...
public class menu_Activity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // view matching
        Button btn_15 = (Button) findViewById(R.id.btn_16);

        btn_15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page17Activity.class);
                startActivity(myIntent);
            }
        });

        // view matching
        Button btn_16 = (Button) findViewById(R.id.btn_17);

        btn_16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page18Activity.class);
                startActivity(myIntent);
            }
        });

        // view matching
        Button btn_17 = (Button) findViewById(R.id.btn_18);

        btn_17.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page19Activity.class);
                startActivity(myIntent);
            }
        });
        ...
        // view matching
        Button btn_19 = (Button) findViewById(R.id.btn_20);

        btn_19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page21Activity.class);
                startActivity(myIntent);
            }
        });

        // view matching
        Button btn_20 = (Button) findViewById(R.id.btn_21);

        btn_20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page22Activity.class);
                startActivity(myIntent);
            }
        });

        // view matching
        Button btn_21 = (Button) findViewById(R.id.btn_22);

        btn_21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page23Activity.class);
                startActivity(myIntent);
            }
        });
        ...
        // view matching
        Button btn_23 = (Button) findViewById(R.id.btn_24);

        btn_23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page25Activity.class);
                startActivity(myIntent);
            }
        });

        // view matching
        Button btn_24 = (Button) findViewById(R.id.btn_25);

        btn_24.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(menu_Activity.this, Page26Activity.class);
                startActivity(myIntent);
            }
        });
